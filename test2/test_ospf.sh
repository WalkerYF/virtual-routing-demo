...
# 给路由器A发送初始化脚本
tmux send -t "init":0.0 "debug start;sleep 6;debug stop$COMMAND_FOR_ALL" Enter

# 给路由器B发送初始化脚本
tmux send -t "init":0.1 "debug start;sleep 6;debug stop$COMMAND_FOR_ALL" Enter

# 给路由器C发送初始化脚本
tmux send -t "init":0.2 "debug start;sleep 6;debug stop$COMMAND_FOR_ALL" Enter

# 给路由器D发送初始化脚本
tmux send -t "init":0.3 "debug start;sleep 6;debug stop$COMMAND_FOR_ALL" Enter

# 给路由器E发送初始化脚本
tmux send -t "init":0.4 "debug start;sleep 6;debug stop$COMMAND_FOR_ALL" Enter

# 给路由器F发送初始化脚本
tmux send -t "init":0.5 "debug start;sleep 6;debug stop$COMMAND_FOR_ALL" Enter

# 给路由器G发送初始化脚本
tmux send -t "init":0.6 "debug start;sleep 6;debug stop$COMMAND_FOR_ALL" Enter
